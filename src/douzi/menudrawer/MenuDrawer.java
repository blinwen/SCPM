package douzi.menudrawer;

import douzi.kaoshi.scpm.R;
...
public abstract class MenuDrawer extends ViewGroup {
    ...
    private static MenuDrawer createMenuDrawer(Activity activity, int dragMode, Position position,
        ...
        if (attachStatic) {
            switch (position) {
                case LEFT:
                    return null;//new LeftStaticDrawer(activity, dragMode);
                case RIGHT:
                    return null;//new RightStaticDrawer(activity, dragMode);
                case TOP:
                    return null;//new TopStaticDrawer(activity, dragMode);
                case BOTTOM:
                    return null;//new BottomStaticDrawer(activity, dragMode);
                default:
